...
var testCases = [
  ...
  },
  {
    ...
    input: { logoName: 'Fred', textColour: 'NotColour' },
  ...
  },
  {
    ...
    input: { logoName: 'Fred', textColour: 'green', bgColour: 'purple' },
  ...
  },
  {
    ...
    input: { logoName: 'Fred', textColour: 'white', bgColour: 'purple' },
    expectedKey: 'bgColour',
    expectedValue: 'purple',
  },
  {
    desc: 'should add text colour if it is a valid color',
    input: { logoName: 'Fred', textColour: 'red', bgColour: 'purple' },
